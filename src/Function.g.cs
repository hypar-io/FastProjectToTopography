...
namespace FastProjectToTopography
{
    public class Function
    {
        ...
        private UrlModelStore<FastProjectToTopographyInputs> store;

        public async Task<FastProjectToTopographyOutputs> Handler(FastProjectToTopographyInputs args)
        {
            ...
            if(this.store == null)
            {
                this.store = new UrlModelStore<FastProjectToTopographyInputs>();
            }
            

            var l = new InvocationWrapper<FastProjectToTopographyInputs,FastProjectToTopographyOutputs> (store, FastProjectToTopography.Execute);
